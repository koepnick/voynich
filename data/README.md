This is where the data lives (by default).

```
./raw         ->  The images as downloaded from the internet
./processed   ->  Mutable files that have been altered in some way
./annotations ->  Where the annotations live
```
...
[Yale's Beinecke Rare Book & Manuscript Library](https://beinecke.library.yale.edu/collections/highlights/voynich-manuscript)
